<?php
// Этот файл chat_widget.php подключается в конце <body> основных страниц
// require_once 'session_check.php'; // Не обязательно здесь, т.к. session_start() будет на основной странице
?>
<!-- Chat Widget Start -->
